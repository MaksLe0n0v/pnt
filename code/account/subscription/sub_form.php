...
<div class="option-window">
    ...
    <div class="account">
        <button href="--><?php /*//= url('account/acc_form') */?><!--"> class="account-text">Личный кабинет</button>
    </div>
    <div class="account" type="reset">
        <button href="--><?php /*//= url('account/subscription/sub_form') */?> class="account-text">Подписка</button>
    </div>
    <div class="account">
        <button href="--><?php /*//= url('account/api_form') */?><!--"> class="account-text">Redmine</button>
    </div>
    <div class="account">
        <button class="account-text"> Страница счета</button>
    </div>
    <div class="account">
