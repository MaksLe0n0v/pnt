...
<div class="option-window">
    ...
    <form>
    <div class="account">
        <button href="<?= url('account/acc_form') ?>" class="account-text">Личный кабинет</button>
    </div>
    <div class="account" type="reset">
        <button href="<?= url('account/subscription/sub_form') ?>" class="account-text">Подписка</button>
    </div>
    <div class="account">
        <button href="<?= url('account/api_form') ?>" class="account-text" type="button">Страница счета</button>
    </div>
    <div class="account">
        <button href="<?= url('account/api_form') ?>" class="account-text">Настройки Redmine</button>
    </div>
    <div class="account">
        <button href="<?= url('auth/_sign-in_form') ?>" class="account-text">Выход</button>
    </div>
